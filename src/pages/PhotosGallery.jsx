...
const PhotosGallery = () => {
    ...
    useEffect(() => {
        const fetchPhotos = async () => {
            ...
            try {
                ...
                console.error('Backend photos error, falling back to static:', err);
                setPhotos(formattedStatic);
            } finally {
                setLoading(false);
            }
    ...
    return (
        <div className="photos-gallery-page bg-[#0A0A0A] min-height-screen">
            <div className="container max-w-6xl mx-auto px-4 py-20">
                ...
                >
                    <h1 className="section-title text-3xl sm:text-4xl font-bold font-accent mb-2">
                        Sharingan Views
                    </h1>
